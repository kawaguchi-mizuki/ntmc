 ...
 * Generated at: 2018-12-17 03:46:03 UTC
...
String stComment = (String)session.getAttribute("stComment"); 
      out.write("\n");
      out.write("\t<form action=\"check\" method = \"GET\">\n");
      out.write("\t\t<h3 id=\"registration\">日誌登録画面</h3>\n");
      out.write("\t\t<table>\n");
      out.write("\t\t<tr>\n");
      out.write("\t\t\t<td><a class=\"btn btn-info btn-lg\" href=\"top\">トップへ戻る</a>\n");
      out.write("\t\t\t<td class=\"registration\"><input type = \"date\" name=\"insertDate\"\n");
      out.write("     \t\t    ");
if(insertDate != null){ 
      out.write(" value = \"");
...
if(errflg != null && errflg.equals("1")){ 
      out.write("\n");
      out.write("\t\t\t<p class =\"errormessage\">空欄があります</p>\n");
      out.write("\t\t");
} else if(errflg != null && errflg.equals("2")){
      out.write("\n");
      out.write("\t\t\t<p class =\"errormessage\">制限文字を超えている欄があります</p>\n");
      out.write("\t\t");
} else if(errflg != null && errflg.equals("3")){
      out.write("\n");
      out.write("\t\t\t<p class =\"errormessage\">空欄と、制限文字を超えている欄があります</p>\n");
      out.write("\t\t");
} else if(errflg != null && errflg.equals("4")){
      out.write("\n");
      out.write("\t\t    <p class =\"errormessage\">");
      out.print(insertDate);
      out.write("の日誌はすでに登録されています</p>\n");
      out.write("\t\t");
} 
      out.write("\n");
      out.write("\n");
      ...
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" name=\"goodPoint\" placeholder=\"30文字以内\"\n");
      out.write("\t\t\t       ");
if(goodPoint != null){ 
      out.write("value = \"");
      ...
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" name=\"badPoint\" placeholder=\"30文字以内\"\n");
      out.write("\t\t\t       ");
if(badPoint != null){ 
      out.write("value = \"");
      ...
      out.write("\t\t\t<input type=\"text\" class=\"form-control\" name=\"stComment\" placeholder=\"30文字以内\"\n");
      out.write("\t\t\t         ");
if(stComment != null){
      out.write(" value = \"");
      ...
      out.write(">\n");
      out.write("\t\t\t<input id=\"registrationbutton\" class=\"btn btn-warning btn-lg btn-block\"\n");
      out.write("\t\t\t type=\"submit\" value=\"次へ\">\n");
      out.write("</form>\n");
