...
public class Appoint_Dao extends DaoBase{

	//映画予約のメソッド//
	public void setAppoint(Appoint_Beans appointBeans) throws SQLException{
		if(con == null) {
			//接続していない場合はエラーとする。//
			return;
		}
	...
	//映画予約確認のメソッド//
	public  List<Appoint_Beans> getList(int userId) throws SQLException{
		if(con == null) {
			//接続していない場合はエラーとする//
			return null;
		}
		List<Appoint_Beans> list = new ArrayList<Appoint_Beans>();
		PreparedStatement stmt = null;
		ResultSet rs = null;
		try {
