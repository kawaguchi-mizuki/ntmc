...
public class User_Dao extends DaoBase {

	//ログイン処理
	public User_Info_Beans getFromUser(String mail,String password) {
		if(con==null) {
			return null;
		}
		User_Info_Beans userInfo=null;
	...
	public User_Info_Beans getFromUser(int id) {
		// TODO 自動生成されたメソッド・スタブ
		if(con==null) {
			return null;
		}
