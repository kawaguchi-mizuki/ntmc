...
<h1 class="common">映画削除確認</h1>
	...
	<br><input type="submit" onclick="location.href='../トップ画面/Adtop.html'" value="戻る" class="back">

	<input type="submit" onclick="location.href='../映画削除完了画面/Addeletefinish.html'" value="削除" class="delete">
</body>
</html>